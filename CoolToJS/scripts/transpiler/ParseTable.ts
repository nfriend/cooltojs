module CoolToJS {
    ...
    export var slr1ParseTable: Array<Array<ParseTableEntry>> = [
            ...
            /* state 3 */[{ action: Action.Reduce, productionIndex: 4 }, null, { action: Action.Reduce, productionIndex: 4 }, { action: Action.Shift, nextState: 4 }, { action: Action.Reduce, productionIndex: 4 }, null, null],
